        ...
        builder: (BuildContext context) {
          return SizedBox(
            ...
            child: CupertinoPicker(
              ...
              itemExtent: 40.0,
              children: [
                MyText('Item - 1', color: theme.colorScheme.onSurface),
                MyText('Item - 2', color: theme.colorScheme.onSurface),
                MyText('Item - 3', color: theme.colorScheme.onSurface),
                MyText('Item - 4', color: theme.colorScheme.onSurface),
                MyText('Item - 5', color: theme.colorScheme.onSurface),
                MyText('Item - 6', color: theme.colorScheme.onSurface),
              ],
            ),
          );
        });
