        ...
        Stack(
          ...
          children: <Widget>[
            MyContainer(
              ...
              borderRadiusAll: 8,
              clipBehavior: Clip.antiAliasWithSaveLayer,
              child: Image.asset(_imageList[i % 12], width: MediaQuery.of(context).size.width, fit: BoxFit.cover),
            ),
            Positioned(
              bottom: 0,
              left: 0,
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: PopupMenuButton(
                            ...
                            return PopupMenuItem(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  MySpacing.width(8),
                                  MyText.labelMedium(choice.text, fontWeight: 600),
                                ],
                              ),
                            );
                          }).toList();
                        ...
                        icon: Icon(Icons.more_vert_sharp, size: 18, color: Colors.white),
