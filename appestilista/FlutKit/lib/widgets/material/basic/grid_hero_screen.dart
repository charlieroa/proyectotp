...
class _GridHeroScreenState extends State<GridHeroScreen> {
  ...
  void _showFullImage(String imagePath, String imageTag) {
    Navigator.of(context).push(
      PageRouteBuilder(
        opaque: false,
        pageBuilder: (BuildContext context, _, _) => FullImageScreen(imagePath: imagePath, imageTag: imageTag, backgroundOpacity: 200),
      ),
    );
  }
        ...
        children: [
          Expanded(
            child: Container(
              ...
              child: GridView.count(crossAxisCount: 3, mainAxisSpacing: 8.0, crossAxisSpacing: 8.0, children: _generateGridItems()),
            ),
          ),
        ],
      ),
