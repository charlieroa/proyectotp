...
class PhotosActionGridViewWidget extends StatefulWidget {
  @override
  _PhotosActionGridViewWidgetState createState() => _PhotosActionGridViewWidgetState();
}
...
class _PhotosActionGridViewWidgetState extends State<PhotosActionGridViewWidget> {
        ...
        Stack(
          children: <Widget>[
            ClipRRect(
              ...
              child: Image.asset(_imageList[i % 15], width: MediaQuery.of(context).size.width, fit: BoxFit.fill),
            ),
            Positioned(
              bottom: 0,
              left: 0,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    MyText.titleMedium("Item $i", fontWeight: 500, color: Colors.white),
                    SizedBox(
                      height: 16,
                      width: 16,
                      child: PopupMenuButton(
                        ...
                        itemBuilder: (BuildContext context) {
                          return _textIconChoice.map((TextIconItem choice) {
                            return PopupMenuItem(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Icon(choice.iconData, size: 20, color: theme.colorScheme.onSurface),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 16, bottom: 0),
                                    child: MyText.labelMedium(choice.text, fontWeight: 600),
                                  ),
                                ],
                              ),
                            );
                        ...
                        icon: Icon(LucideIcons.ellipsis_vertical, size: 18, color: Colors.white),
      ...
      builder: (controller) {
        return Scaffold(
          ...
          body: Container(
            ...
            color: theme.colorScheme.surface,
            child: GridView.count(crossAxisCount: 2, mainAxisSpacing: 8, crossAxisSpacing: 8, children: _generateGridItems()),
          ),
        );
      },
    );
