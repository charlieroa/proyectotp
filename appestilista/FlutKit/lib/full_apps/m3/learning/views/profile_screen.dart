          ...
          child: Column(
            children: [
              ...
              _buildSingleSetting('Preferences', 'Themes, Settings',
                  LucideIcons.settings, theme.colorScheme.onSurface),
              Divider(),
              _buildSingleSetting(
                  'Notification',
              ...
              _buildSingleSetting('Help', 'Contact Us',
                  LucideIcons.message_circle, theme.colorScheme.onSurface),
              Divider(),
              _buildSingleSetting('About', 'About the application',
                  LucideIcons.circle_alert, theme.colorScheme.onSurface),
              Divider(),
              InkWell(
                onTap: () {
                  controller.logout();
                ...
                child: _buildSingleSetting('Log Out', 'Exit from your account',
                    LucideIcons.log_out, theme.colorScheme.primary),
              ),
