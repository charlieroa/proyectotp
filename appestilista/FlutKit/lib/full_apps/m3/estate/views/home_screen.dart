...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _selectSizeSheet(BuildContext context) {
...
class SingleBed extends StatefulWidget {
  ...
  const SingleBed({super.key, required this.bed, required this.selected});
...
class SingleBath extends StatefulWidget {
  ...
  const SingleBath({super.key, required this.bath, required this.selected});
