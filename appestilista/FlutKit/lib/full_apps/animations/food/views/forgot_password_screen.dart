...
import 'package:flutkit/full_apps/animations/food/controllers/forgot_password_controller.dart';
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ForgotPasswordController>(
        init: controller,
        tag: 'food_forgot_password_controller',
        builder: (controller) {
          return _buildBody();
        });
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              MySpacing.height(12),
              MyText.bodySmall(
                'Enter your mail id to get link to set new password.',
                xMuted: true,
              ),
              MySpacing.height(20),
              TextFormField(
