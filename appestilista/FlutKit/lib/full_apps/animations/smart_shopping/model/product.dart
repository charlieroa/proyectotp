...
class Product {
  ...
  static Product fromJson(Map<String, dynamic> jsonObject) {
    ...
    String category = jsonObject['category'].toString();

    return Product(name, image, description, rating, price, review, quantity, color, favorite, category);
  }
  ...
  static Future<String> getData() async {
    return await rootBundle.loadString('assets/full_apps/animations/shopping/data/products.json');
  }
}
