import 'package:flutkit/full_apps/animations/plant/views/plant_forgot_password_screen.dart';
import 'package:flutkit/full_apps/animations/plant/views/plant_full_app_screen.dart';
import 'package:flutkit/full_apps/animations/plant/views/plant_register_screen.dart';
import 'package:flutkit/helpers/utils/my_string_utils.dart';
import 'package:flutter/cupertino.dart';
import 'package:get/get.dart';

class PlantLoginController extends GetxController {
  TickerProvider ticker;

  PlantLoginController(this.ticker);
  ...
  Future<void> login() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      Get.off(() => PlantFullAppScreen());
      update();
    }
  }

  void onChangeCheckBox(bool? value) {
    rememberBox = value ?? rememberBox;
    update();
  }

  void gotoForgotPasswordScreen() {
    Get.to(PlantForgotPasswordScreen());
    update();
  }

  void gotoRegisterScreen() {
    Get.to(PlantRegisterScreen());
    update();
  }
}
