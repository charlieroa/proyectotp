...
class _ShoppingAddCardScreenState extends State<ShoppingAddCardScreen> with SingleTickerProviderStateMixin {
  ...
  TextEditingController? cardNumberTextEditingController, cardDateTextEditingController, cardNameTextEditingController, cardCVVTextEditingController;

  //Focus node
  FocusNode? creditNumberFocusNode, creditDateFocusNode, creditNameFocusNode, creditCVVFocusNode;
  ...
  initState() {
    ...
    _controller = AnimationController(vsync: this, duration: Duration(milliseconds: 400), value: 1);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        leading: IconButton(onPressed: () => Navigator.of(context).pop(), icon: Icon(LucideIcons.chevron_left)),
        ...
        actions: <Widget>[
          InkWell(
            ...
            child: Container(margin: MySpacing.right(24), child: Icon(LucideIcons.check)),
          ),
        ],
      ),
      body: Column(
                  ...
                  child: isFront
                      ? Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(width: 0.7, color: theme.colorScheme.surface),
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Container(
                                  ...
                                  child: MyText.titleMedium("VISA", fontWeight: 700, color: creditCardColor),
                                ),
                              ),
                              MyText.titleMedium(creditCardNumber, fontWeight: 600, letterSpacing: 0.5, wordSpacing: 1, color: Colors.white),
                              MyText.titleMedium(creditCardDate, fontWeight: 600, letterSpacing: 0.5, wordSpacing: 1, color: Colors.white),
                              MyText.titleMedium(creditCardName, fontWeight: 500, letterSpacing: 0.3, wordSpacing: 1, color: Colors.white),
                            ],
                          ),
                        )
                      : Container(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  children: <Widget>[
                                    Expanded(child: Container(height: 36, color: Color(0xffbdc2d8))),
                                    Container(
                                      width: 100,
                                      height: 28,
                                      color: Colors.white,
                                      ...
                                      child: MyText.titleMedium(creditCardCVV, color: Colors.black, fontWeight: 600, letterSpacing: 0.5),
                                    ),
                                  ],
                                ),
                                Container(
                                  ...
                                  child: Container(
                                    padding: MySpacing.xy(8, 4),
                                    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(4))),
                                    child: MyText.bodyLarge("VISA", fontWeight: 700, color: creditCardColor),
                                  ),
                                ),
                              ],
                            ),
              ...
              children: <Widget>[
                TextFormField(
                  decoration: InputDecoration(
                    ...
                    prefixIcon: Icon(LucideIcons.rectangle_ellipsis),
                  ),
                ...
                TextFormField(
                  decoration: InputDecoration(
                    ...
                    enabledBorder: theme.inputDecorationTheme.border,
                    focusedBorder: theme.inputDecorationTheme.focusedBorder,
                    prefixIcon: Icon(LucideIcons.calendar_range),
                  ),
                  controller: cardDateTextEditingController,
                  keyboardType: TextInputType.number,
                  textCapitalization: TextCapitalization.sentences,
                  focusNode: creditDateFocusNode,
                  inputFormatters: [MyCardMonthInputFormatter(), LengthLimitingTextInputFormatter(5)],
                ),
                MySpacing.height(24),
                TextFormField(
                  decoration: InputDecoration(
