...
class _GroceryCouponScreenState extends State<GroceryCouponScreen> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: theme.copyWith(colorScheme: theme.colorScheme.copyWith(secondary: customTheme.groceryPrimary)),
      child: Scaffold(
          appBar: AppBar(
            elevation: 0,
            leading: IconButton(
          ...
          body: ListView(
            ...
            children: <Widget>[
              singleCoupon(LucideIcons.shopping_cart, CustomTheme.purple, "Cart", "Shop", 60, "CART30"),

              singleCoupon(LucideIcons.gamepad, CustomTheme.orange, "Sony", "PS5", 35, "SPS35"),
            ],
          )),
    );
  }

  Widget singleCoupon(IconData iconData, Color color, String company, String product, int offer, String code) {
    return MyContainer(
        ...
        children: [
          Column(
            children: [
              Container(
                padding: MySpacing.all(16),
                decoration: BoxDecoration(shape: BoxShape.circle, color: color.withAlpha(200)),
                child: Icon(
                  iconData,
          ...
          Expanded(
            ...
            children: [
              ...
              Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  MyText.bodySmall("Promo code:", xMuted: true, letterSpacing: -0.2),
                  MySpacing.width(8),
                  MyContainer(
