...
class DatingHomeController extends GetxController {
  ...
  Future<void> nextPage() async {
    if (currentPage == numPages - 1) {
      ...
      await pageController.animateToPage(currentPage + 1, duration: Duration(milliseconds: 600), curve: Curves.ease);
    }
  }
  ...
  Future<void> onPageChanged(int page, {bool fromUser = false}) async {
    ...
    update();
    if (fromUser) {
      await pageController.animateToPage(page, duration: Duration(milliseconds: 600), curve: Curves.ease);
    }
  }
