...
class WalletCryptoScreen extends StatefulWidget {
  const WalletCryptoScreen({super.key});

  @override
  State<WalletCryptoScreen> createState() => _WalletCryptoScreenState();
}
...
class _SingleRate extends StatelessWidget {
  ...
  const _SingleRate(
      {required this.name, required this.rate, required this.changes});
