                            ...
                            children: <Widget>[
                              Expanded(
                                child: Column(
                                  children: <Widget>[
                                    _QuickActionWidget(
                                      iconData: LucideIcons.phone_call,
                                      actionText: 'Prepaid',
                                    ),
                                    _QuickActionWidget(
                                      iconData: LucideIcons.train_front,
                                      actionText: 'Metro',
                                    ),
                                    _QuickActionWidget(
...
class _RecentWidget extends StatelessWidget {
  ...
  const _RecentWidget({required this.image, required this.name});
...
class _QuickActionWidget extends StatelessWidget {
  ...
  const _QuickActionWidget(
      {required this.iconData, required this.actionText});
