...
class NewsFullApp extends StatefulWidget {
  const NewsFullApp({super.key});

  @override
  State<NewsFullApp> createState() => _NewsFullAppState();
}
      ...
      bottomNavigationBar: CustomBottomNavigation(
        ...
        items: <CustomBottomNavigationBarItem>[
          CustomBottomNavigationBarItem(
              ...
              activeIcon: Icon(LucideIcons.house, size: 20),
          ...
          CustomBottomNavigationBarItem(
              title: "Video",
              icon: Icon(LucideIcons.circle_play, size: 20),
              activeIcon: Icon(LucideIcons.circle_play, size: 20),
              activeColor: navigationTheme.selectedItemColor,
              inactiveColor: navigationTheme.unselectedItemColor),
          CustomBottomNavigationBarItem(
              title: "Profile",
