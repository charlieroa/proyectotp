...
class NewsProfileScreen extends StatefulWidget {
  const NewsProfileScreen({super.key});

  @override
  State<NewsProfileScreen> createState() => _NewsProfileScreenState();
}
              ...
              Column(
                ...
                children: [
                  MyText.bodyMedium("Account",
                      color: theme.colorScheme.onSurface, fontWeight: 700),
        ...
        Container(
          ...
          child: Column(
            children: [
              ListTile(
                leading: Icon(
                  LucideIcons.mail_question_mark,
                  color: theme.colorScheme.onSurface,
                ),
      ...
      child: Column(
        children: [
          ...
          MyText.bodyMedium("Get more done with pro",
              color: theme.colorScheme.onSurface, fontWeight: 500),
          Container(
