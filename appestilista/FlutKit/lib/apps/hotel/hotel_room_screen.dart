              ...
              Row(
                children: <Widget>[
                  Expanded(
                    ...
                    iconData: LucideIcons.dollar_sign,
                    text: "Low Cost",
                  )),
                  Expanded(
                      child: _FacilityWidget(
                  ...
                  Expanded(
                      child: _FacilityWidget(
                    iconData: LucideIcons.party_popper,
                    text: "Party",
                  )),
                  Expanded(
                      child: _FacilityWidget(
                ...
                onPressed: () {
                  Navigator.push(
                      ...
                      PageRouteBuilder(
                          ...
                          pageBuilder: (_, _, _) => HotelReviewScreen()));
                },
...
class _FacilityWidget extends StatelessWidget {
  ...
  const _FacilityWidget({required this.iconData, required this.text});
