...
class MusicPodcastScreen extends StatefulWidget {
  const MusicPodcastScreen({super.key});

  @override
  State<MusicPodcastScreen> createState() => _MusicPodcastScreenState();
}
...
class _SingleShowWidget extends StatelessWidget {
  ...
  const _SingleShowWidget(
      {required this.image, required this.text, required this.height});
