                ...
                ExpansionPanel(
                    ...
                    body: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          singleMenuItem(
                              image: './assets/images/apps/food/pasta-1.jpg',
                              name: 'Peperoni pizza',
                              price: 25.99,
                              rate: 4.5),
                        ],
                ...
                ExpansionPanel(
                    ...
                    body: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          singleMenuItem(
                              image: './assets/images/apps/food/burger-1.jpg',
                              name: 'Peperoni pizza',
                              price: 25.99,
                              rate: 4.5),
                          singleMenuItem(
                              ...
                              rate: 3.5),
                          singleMenuItem(
                              image: './assets/images/apps/food/burger-3.jpg',
                              name: 'Margherita',
                              price: 24.79,
                              rate: 4),
                        ],
                ...
                ExpansionPanel(
                    ...
                    body: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          singleMenuItem(
                              image: './assets/images/apps/food/beverage-1.jpg',
                              name: 'Peperoni pizza',
                              price: 25.99,
                              rate: 4.5),
                          singleMenuItem(
                              image: './assets/images/apps/food/beverage-2.jpg',
                              name: 'Meat Pizza',
                              price: 21.99,
                              rate: 3.5),
                          singleMenuItem(
                ...
                ExpansionPanel(
                    ...
                    body: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          singleMenuItem(
                              image: './assets/images/apps/food/dessert-1.jpg',
                              name: 'Peperoni pizza',
                              price: 25.99,
                              rate: 4.5),
                          singleMenuItem(
                              image: './assets/images/apps/food/dessert-2.jpg',
                              name: 'Meat Pizza',
                              price: 21.99,
                              rate: 3.5),
                          singleMenuItem(
                              ...
                              rate: 4),
                          singleMenuItem(
                              image: './assets/images/apps/food/dessert-4.jpg',
                              name: 'Hawaiian Pizza',
                              price: 29.80,
                              rate: 5),
                        ],
