...
class ShoppingOrderStatusScreen extends StatefulWidget {
  const ShoppingOrderStatusScreen({super.key});

  @override
  State<ShoppingOrderStatusScreen> createState() =>
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      MyText.titleSmall("Cash on Delivery", fontWeight: 600),
                      Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          MyText.titleSmall("Status : ", fontWeight: 500),
        ...
        Stepper(
          ...
          steps: <Step>[
            Step(
              ...
              title:
                  MyText.bodyLarge('Order placed - 14 April', fontWeight: 600),
            ...
            Step(
              ...
              title: MyText.bodyLarge('Payment confirmed - 14 april',
                  fontWeight: 600),
              content: SizedBox(
                child: MyText.titleSmall("Pay via debit card", fontWeight: 600),
              ),
            ),
            Step(
              isActive: true,
              state: StepState.complete,
              title: MyText.bodyLarge('Processing - 16 April', fontWeight: 600),
              content: SizedBox(
