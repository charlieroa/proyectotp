...
import 'package:flutkit/apps/shopping/shopping_full_app.dart';
...
class ShoppingLoginScreen extends StatefulWidget {
  const ShoppingLoginScreen({super.key});

  @override
  State<ShoppingLoginScreen> createState() => _ShoppingLoginScreenState();
}
