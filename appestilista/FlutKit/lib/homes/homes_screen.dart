...
class _HomesScreenState extends State<HomesScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Widget> bottomBarPages = [AnimationsHome(), FullAppsHome(), AppsHome(), MaterialWidgetsHome(), OthersHome()];
  ...
  void launchDocumentation() async {
    String url = "https://flutkit.coderthemes.com/introduction.html";
    await launchUrl(Uri.parse(url));
  }
        ...
        return Theme(
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(icon: Icon(LucideIcons.rocket), label: 'Animation', backgroundColor: theme.colorScheme.surface),
                BottomNavigationBarItem(icon: Icon(LucideIcons.house), label: 'Full Apps', backgroundColor: theme.colorScheme.surface),
                BottomNavigationBarItem(icon: Icon(LucideIcons.layout_dashboard), label: 'Apps', backgroundColor: theme.colorScheme.surface),
                BottomNavigationBarItem(icon: Icon(LucideIcons.boxes), label: 'Widgets', backgroundColor: theme.colorScheme.surface),
                BottomNavigationBarItem(icon: Icon(LucideIcons.layers), label: 'Others', backgroundColor: theme.colorScheme.surface),
              ],
              elevation: 2,
  ...
  Widget _buildDrawer() {
    return MyContainer.none(
      margin: MySpacing.fromLTRB(16, MySpacing.safeAreaTop(context) + 16, 16, 16),
      borderRadiusAll: 4,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  MyContainer(
                    ...
                    child: MyText.bodyLarge("v15", color: theme.colorScheme.primary, fontWeight: 700, letterSpacing: 0.2),
                  ),
                  MySpacing.height(16),
                  MyText.bodyMedium("Flutter 3.13 (Latest)", fontWeight: 600, letterSpacing: 0.2),
                ],
              ),
            ),
            MySpacing.height(32),
                      ...
                      children: [
                        MyContainer(
                          ...
                          child: Image(
                            height: 20,
                            width: 20,
                            image: AssetImage(AppTheme.textDirection == TextDirection.ltr ? Images.paragraphRTLOutline : Images.paragraphLTROutline),
                        ...
                        Expanded(
                          child: MyText.bodyLarge(
                            AppTheme.textDirection == TextDirection.ltr ? "${'right_to_left'.tr()} (RTL)" : "${'left_to_right'.tr()} (LTR)",
                          ),
                        ),
                        MySpacing.width(16),
                        Icon(
