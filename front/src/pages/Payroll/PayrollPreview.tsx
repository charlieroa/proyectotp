...
interface Stylist { id: string; name: string; avatar: string; netToPay: number; stylistTips: number; clients: Client[]; inventory: InventoryItem[]; expenses: Expense[]; }
                                ...
                                <div>
                                    ...
                                    {selectedStylist.stylistTips > 0 && (
                                        <div className="alert alert-info py-2 px-3 mb-3 d-flex justify-content-between align-items-center">
                                            <span><i className="ri-hand-coin-line me-1"></i> Propinas del periodo:</span>
                                            <strong>{formatterCOP.format(selectedStylist.stylistTips)}</strong>
                                        </div>
                                    )}
