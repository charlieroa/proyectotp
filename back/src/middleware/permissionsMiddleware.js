...
exports.authorize = (allowedRoles) => {
  ...
  return (req, res, next) => {
    ...
    // =======================================================
    // Si el rol del usuario es 1 (Admin) o 5 (Super Admin), le damos acceso total e inmediato.
    // No importa qué `allowedRoles` le pasemos, el Admin siempre pasa.
    if (userRoleId === 1 || userRoleId === 5) {
      return next(); // El Admin/Super Admin tiene vía libre. Continúa a la siguiente función (el controlador).
    }
